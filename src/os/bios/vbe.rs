...
impl Iterator for VideoModeIter {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        loop {
            // Definir bit 14 para obter linear frame buffer
            ...
            if data.eax == 0x004F {
                ...
                // Suportamos apenas modos de 32-bits por pixel
                ...
                // TODO: suportar stride que não seja múltiplo de 4
